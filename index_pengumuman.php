...
John Abraham</h5>
      ...
      <div class="nav-left-sidebar sidebar-dark">
                ...
                <nav class="navbar navbar-expand-lg navbar-light">
                    ...
                    <div class="collapse navbar-collapse" id="navbarNav">
                        <ul class="navbar-nav flex-column">
                            ...
                            <li class="nav-item">
                            <a class="nav-link" href="index_pengumuman.php" data-toggle="collapse" aria-expanded="false" data-target="#submenu-2" aria-controls="submenu-2"><i class="fa fa-fw fa-rocket"></i>Pengumuman</a>
        ...
        <div class="dashboard-wrapper">
            ...
            <form action="koneksi_tambah_pengumuman.php" method="post">		
		<table>
			<tr>
				<td>Pengumuman : </td>
				<td>
            ...
            <div class="container-fluid dashboard-content tabel-berscroll">
            <table border="1" class="table ">
		<tr>
			<th colspan="3">Pengumuman Terbaru</th>
		</tr>
    <tr>
			<th>No</th>
      <th>Pengumuman</th>
...
<?php 
		...
		<tr>
			...
			<td>
				<a class="edit" href="index_edit_pengumuman.php?id=<?php echo $data['kode_pengumuman']; ?>">Edit</a> |
				<a class="hapus" href="hapus_pengumuman.php?id= <?php echo $data['kode_pengumuman']; ?>">Hapus</a> 			
			</td>
		</tr>
		<?php } ?>
	</table>               
