...
<nav class="navbar navbar-expand-lg navbar-light" style="background-color: #62d44d ;">
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent" >
    <ul class="navbar-nav mr-auto">
      ...
      <li class="nav-item">
        <a class="nav-link" href="../absensi/index_absen.php" style="color: white;">Absen</a>
      </li>
      <li class="nav-item">
        <a class="nav-link" href="../jadwal/index_jadwal.php" style="color: white;">Jadwal</a>
      </li>
      <li class="nav-item">
        <a class="nav-link" href="../nilai/index_nilai.php" style="color: white;">Nilai</a>
      </li>
...
<fieldset>
				...
				<br>
					<table width="50% " border="1px" class="table table-bordered table-striped mb-0"style=" border-collapse:collapse;">
						...
						$q = mysqli_query($host, "SELECT * FROM `tb_absen` ta JOIN tb_siswa ts on ta.nis=ts.nis WHERE ta.nis='$_SESSION[siswa]' $where ");
